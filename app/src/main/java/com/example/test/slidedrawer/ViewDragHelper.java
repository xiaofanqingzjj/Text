...
public class ViewDragHelper {
    ...
    public abstract static class Callback {
         ...
         */
        public abstract boolean tryCaptureView(@NonNull View child, int pointerId, int x, int y);
     ...
     */
    boolean tryCaptureViewForDrag(View toCapture, int pointerId, int x, int y) {
        if (toCapture == mCapturedView && mActivePointerId == pointerId) {
            // Already done!
            return true;
        }
        if (toCapture != null && mCallback.tryCaptureView(toCapture, pointerId, x, y)) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                for (int i = 0; i < pointerCount; i++) {
                    ...
                    if (pastSlop && tryCaptureViewForDrag(toCapture, pointerId, (int) x, (int) y)) {
                        break;
                    }
                }
                saveLastMotion(ev);
                ...
                if (mDragState == STATE_DRAGGING && pointerId == mActivePointerId) {
                    ...
                    for (int i = 0; i < pointerCount; i++) {
                        ...
                        if (findTopChildUnder((int) x, (int) y) == mCapturedView
                                && tryCaptureViewForDrag(mCapturedView, id, (int) x, (int) y)) {
