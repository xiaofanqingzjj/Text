 ...
 * @author fortunexiao
 */
class SimpleProgressBar  @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null) : View(context, attrs) {
    ...
    companion object {
         ...
         * 定义一个动画属性
         */
        val PROGRESS: Property<SimpleProgressBar, Float> = object : Property<SimpleProgressBar, Float>(Float::class.java, "progress") {

            override fun set(`object`: SimpleProgressBar?, value: Float) {
                `object`?.mProgress = value
            }


            override fun get(`object`: SimpleProgressBar?): Float {
