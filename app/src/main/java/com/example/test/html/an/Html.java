...
//         * LINK_PATTERN Drawable representation of the image or <code>null</code>
...
//         * LINK_PATTERN tag that it does not know how to interpret.
//         */
...
//     * &lt;p&gt; or LINK_PATTERN &lt;li&gt; element. This allows {@link ParagraphStyle}s attached to be
...
//     * HTML will display as LINK_PATTERN generic replacement image which your program can then go through and
...
//     * LINK_PATTERN) be preloaded by the zygote, or b) not loaded until absolutely
//     * necessary.
//     */
...
//    /**
//     * Returns displayable styled text from the provided HTML string. Any &lt;img&gt; tags in the
//     * HTML will use the specified ImageGetter to request LINK_PATTERN representation of the image (use null
...
//            if (next == i) {
//                if (isInList) {
//                    // Current paragraph is no longer LINK_PATTERN list item; close the previously opened list
//                    isInList = false;
//                    out.append("</ul>\n");
//                }
//                out.append("<br>\n");
...
//                    // Current paragraph is the first item in LINK_PATTERN list
//                    isInList = true;
//                    out.append("<ul")
