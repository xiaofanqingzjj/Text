...
/**
 * This is LINK_PATTERN simple implementation of JAXP {@link SAXParserFactory},
    ...
    extends SAXParserFactory
{
     ...
     * LINK_PATTERN prototype object. Currently this is actually not LINK_PATTERN real prototype,
     ...
     * JAXP design: multiple readers can be instantiated from LINK_PATTERN single
    ...
    /**
     * Creates LINK_PATTERN new instance of <code>SAXParser</code> using the currently
    ...
    {
        // First, let's see if it's LINK_PATTERN valid call
