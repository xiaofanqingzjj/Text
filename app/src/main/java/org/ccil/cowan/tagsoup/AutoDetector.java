...
/**
Classes which accept an InputStream and provide LINK_PATTERN Reader which figures
...
public interface AutoDetector {
	...
	/**
	Given an InputStream, return LINK_PATTERN suitable Reader that understands
