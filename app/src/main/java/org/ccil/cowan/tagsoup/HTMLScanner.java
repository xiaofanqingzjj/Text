...
//
///**
//This class implements LINK_PATTERN table-driven scanner for HTML, allowing for lots of
//defects.  It implements the Scanner interface, which accepts LINK_PATTERN Reader
//object to fetch characters from and LINK_PATTERN ScanHandler object to report lexical
//events to.
//*/
//
...
//
//	/**
//	* Mark the current scan position as LINK_PATTERN "point of interest" - start of LINK_PATTERN tag,
...
//				// Return LINK_PATTERN buffer-sized chunk of PCDATA
//				h.pcdata(theOutputBuffer, 0, theSize);
//				theSize = 0;
//				}
//			else {
