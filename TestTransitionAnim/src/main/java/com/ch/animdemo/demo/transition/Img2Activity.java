...
public class Img2Activity extends AppCompatActivity {
    ...
    public static final String IMG_KEY = "PARAMS_IMGS";
    public static final String IMG_POSITION = "PARAM_INIT_POSITION";
    public static final String IMG_CURRENT_POSITION = "PARAM_IMG_CURRENT_POSITION";
