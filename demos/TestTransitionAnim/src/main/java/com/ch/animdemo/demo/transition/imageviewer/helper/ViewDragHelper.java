...
package com.ch.animdemo.demo.transition.imageviewer.helper;
...
public class ViewDragHelper {
    ...
    public abstract static class Callback {
        ...
        public boolean checkTouchSlop(View child, float dx, float dy) {return true;}
    }
    ...
    private boolean checkTouchSlop(View child, float dx, float dy) {
        ...
        final boolean checkSlop = mCallback.checkTouchSlop(child, dx, dy);
        if (checkSlop) {
