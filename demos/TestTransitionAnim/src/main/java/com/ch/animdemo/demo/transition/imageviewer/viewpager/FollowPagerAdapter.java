 ...
 * a {@link FollowViewPager}.  You will most likely want to use a more
 * specific implementation of this, such as
 * {@link android.support.v4.app.FragmentPagerAdapter} or
 * {@link android.support.v4.app.FragmentStatePagerAdapter}.
 *
 * <p>When you implement a FollowPagerAdapter, you must override the following methods
 * at minimum:</p>
 * <ul>
 ...
 * </ul>
 *
 * <p>FollowPagerAdapter is more general than the adapters used for
 ...
 * steps taken during an update. A FollowPagerAdapter may implement a form of View
 ...
 * independent of its position in the adapter. A call to the FollowPagerAdapter method
 ...
 *
 * <p>A very simple FollowPagerAdapter may choose to use the page Views themselves
 ...
 *
 * <p>FollowPagerAdapter supports data set changes. Data set changes must occur on the
 ...
 */
public abstract class FollowPagerAdapter {
     ...
     * required for a FollowPagerAdapter to function properly.
     *
