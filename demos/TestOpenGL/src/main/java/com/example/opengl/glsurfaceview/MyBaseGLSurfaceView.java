...
package com.example.opengl.glsurfaceview;
 ...
 *
 */
public class MyBaseGLSurfaceView extends SurfaceView implements SurfaceHolder.Callback2 {
     ...
     * this interface, and then call {@link MyBaseGLSurfaceView#setRenderer} to
     ...
     * use the {@link MyBaseGLSurfaceView#queueEvent(Runnable)} convenience method.
     * <p>
     ...
     * {@link MyBaseGLSurfaceView#setEGLContextFactory(EGLContextFactory)}
     */
     ...
     * <p>
     * This interface must be implemented by clients wishing to call
     * {@link MyBaseGLSurfaceView#setEGLWindowSurfaceFactory(EGLWindowSurfaceFactory)}
     */
     ...
     * <p>
     * This interface must be implemented by clients wishing to call
     * {@link MyBaseGLSurfaceView#setEGLConfigChooser(EGLConfigChooser)}
     */
    ...
    private static class EglHelper {
        public EglHelper(WeakReference<MyBaseGLSurfaceView> glSurfaceViewWeakRef) {
        ...
        public void start() {
            ...
            MyBaseGLSurfaceView view = mGLSurfaceViewWeakRef.get();
            if (view == null) {
                mEglConfig = null;
                mEglContext = null;
            } else {
...
//                }
        ...
        private WeakReference<MyBaseGLSurfaceView> mGLSurfaceViewWeakRef;
    ...
    static class GLThread extends Thread {
        GLThread(WeakReference<MyBaseGLSurfaceView> glSurfaceViewWeakRef) {
            super();
            mWidth = 0;
            mHeight = 0;
            mRequestRender = true;
                ...
                while (true) {
                    synchronized (sGLThreadManager) {
                        while (true) {
                            ...
                            // 从事件队列中获取事件，如果有值，退出循环处理事件，否则进行初始化
...
//                                Trace.traceEnd(Trace.TRACE_TAG_VIEW);
    ...
    private final WeakReference<MyBaseGLSurfaceView> mThisWeakRef =
            new WeakReference<MyBaseGLSurfaceView>(this);
